...
#    label=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/label.csv',dtype=np.float32,delimiter=',')
    data1=np.loadtxt('C:/Users/24497/Desktop/DBM feature extraction1.0/DBM feature extraction/yundongshengxue/yundongxuej.csv',dtype=np.float32,delimiter=',')
#    data1=np.loadtxt('C:/Users/24497/Desktop/DBM feature extraction1.0/DBM feature extraction/yundongshengxue/yundongxue384j.csv',dtype=np.float32,delimiter=',')
