...
#    data=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/yundongxue.csv',dtype=np.float32,delimiter=',')
#    label=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/label.csv',dtype=np.float32,delimiter=',')
#    data1=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/384j.csv',dtype=np.float32,delimiter=',')
    data0=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/yundongxue384j.csv',dtype=np.float32,delimiter=',') 
    data2=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/384j.csv',dtype=np.float32,delimiter=',') 
    data3=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/yundongxuej.csv',dtype=np.float32,delimiter=',') 
    data4=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/fayinsudu.csv',dtype=np.float32,delimiter=',') 
    data5=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/maxming.csv',dtype=np.float32,delimiter=',')
    data6=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/384.csv',dtype=np.float32,delimiter=',') 
    data7=np.loadtxt('d:/E/shujuku/DBM feature extraction/yundongshengxue/yundongxue.csv',dtype=np.float32,delimiter=',') 
...
#    data4 = sel.fit_transform(data4)
#    
##    data = StandardScaler().fit_transform(data)
#    data4 = MinMaxScaler().fit_transform(data4)  # 特征归一化
#        # 去除重复的列
#    data4 = np.unique(data4, axis=1)  
#
#
#
#    sel = VarianceThreshold(threshold=(0))  # .8 * (1 - .8)=0.159998
#    data5 = sel.fit_transform(data5)
#    
##    data = StandardScaler().fit_transform(data)
#    data5 = MinMaxScaler().fit_transform(data5)  # 特征归一化
#        # 去除重复的列
#    data5 = np.unique(data5, axis=1) 
#    
#
#    sel = VarianceThreshold(threshold=(0))  # .8 * (1 - .8)=0.159998
#    data6 = sel.fit_transform(data6)
#    
##    data = StandardScaler().fit_transform(data)
#    data6 = MinMaxScaler().fit_transform(data6)  # 特征归一化
#        # 去除重复的列
#    data6 = np.unique(data6, axis=1) 
#
#    
#    data44 = np.c_[data4,data5]
#
#    
#    sel = VarianceThreshold(threshold=(0))  # .8 * (1 - .8)=0.159998
#    data44 = sel.fit_transform(data44)
#    
##    data = StandardScaler().fit_transform(data)
#    data44 = MinMaxScaler().fit_transform(data44)  # 特征归一化
#        # 去除重复的列
#    data44 = np.unique(data44, axis=1) 


    sel = VarianceThreshold(threshold=(0))  # .8 * (1 - .8)=0.159998
    data7 = sel.fit_transform(data7)
    
#    data = StandardScaler().fit_transform(data)
    data7 = MinMaxScaler().fit_transform(data7)  # 特征归一化
        # 去除重复的列
    data7 = np.unique(data7, axis=1) 



    label = data2[:,-1] 
    data = np.c_[data7,label]
#    data = np.c_[data4,data5,label]
...
#    # 去除方差为0的列
#    sel = VarianceThreshold(threshold=(0))  # .8 * (1 - .8)=0.159998
#    data1 = sel.fit_transform(data1)
    
#    data = StandardScaler().fit_transform(data)
#    data1 = MinMaxScaler().fit_transform(data1)  # 特征归一化
#        # 去除重复的列
#    data1 = np.unique(data1, axis=1)  
#
#    data = np.c_[data1,label]
#   
