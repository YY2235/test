...
#****************写入********************         
        deep_TYUT_train = train_data
        deep_TYUT_test = test_data
        print("保存深度特征")
        #np.savetxt("../saver/deep_TYUT_jh_15_21_train.csv", deep_TYUT_train, fmt='%.4f',delimiter=",")
       # np.savetxt("../saver/deep_TYUT_jh_15_21_test.csv", deep_TYUT_test, fmt='%.4f',delimiter=",")
        #np.savetxt("../saver/deep_bolin_hb_200_150_train.csv", deep_TYUT_train, fmt='%.4f',delimiter=",")
        #np.savetxt("../saver/deep_bolin_hb_200_150_test.csv", deep_TYUT_test, fmt='%.4f',delimiter=",")
        #np.savetxt("../saver2/deep_TYUT_hb_400_150_train.csv", deep_TYUT_train, fmt='%.4f',delimiter=",")
        #np.savetxt("../saver2/deep_TYUT_hb_400_150_test.csv", deep_TYUT_test, fmt='%.4f',delimiter=",")
       #
#        np.savetxt("../shunxu/train.csv", deep_TYUT_train, fmt='%.4f',delimiter=",")
#        np.savetxt("../shunxu/test.csv", deep_TYUT_test, fmt='%.4f',delimiter=",")

        np.savetxt("../yundongshengxue/train.csv", deep_TYUT_train, fmt='%.4f',delimiter=",")
        np.savetxt("../yundongshengxue/test.csv", deep_TYUT_test, fmt='%.4f',delimiter=",")
        
        print(deep_TYUT_train.shape)
        print(deep_TYUT_test.shape)
#****************************************           
    ...
    def save_result(self):
        ...
        #np.savetxt("../saver/bolinhbacc_list.csv", self.acc_list, fmt='%.4f',delimiter=",")
        #np.savetxt("../saver/bolinhblabel_distribution.csv", self.label_distribution, fmt='%.4f',delimiter=",")
        #np.savetxt("../saver/bolinhbloss_and_acc.csv", self.train_curve, fmt='%.4f',delimiter=",")
        
        #np.savetxt("../saver1/SAVEEhbacc_list.csv", self.acc_list, fmt='%.4f',delimiter=",")
        #np.savetxt("../saver1/SAVEEhblabel_distribution.csv", self.label_distribution, fmt='%.4f',delimiter=",")
        #np.savetxt("../saver1/SAVEEhbloss_and_acc.csv", self.train_curve, fmt='%.4f',delimiter=",")
        
        np.savetxt("../saverbem/BLacc_list.csv", self.acc_list, fmt='%.4f',delimiter=",")
        np.savetxt("../saverbem/BLlabel_distribution.csv", self.label_distribution, fmt='%.4f',delimiter=",")
        np.savetxt("../saverbem/BLloss_and_acc.csv", self.train_curve, fmt='%.4f',delimiter=",")
